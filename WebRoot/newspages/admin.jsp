  ...
  <div id="opt_area">    
    ...
    <ul class="classlist">
     ...
     --%>
     	<!--  
     	<li><--%=t.getTopicName() %> &#160;&#160;
     		<a href="TopicServlet?action=to_modify&tid=<--%=t.getTid() %>&topic_name=<--%=t.getTopicName() %>">修改</a>&#160;&#160;
     		<a href="">删除</a>
     	</li>
     	-->
     <%--      	     	
     ...
     <c:forEach var="t" items="${topicList }">
     	...
     	<li>${t.topicName }&#160;&#160;
     		<a href="topic_update.jsp?tid=${t.tid }">修改</a>&#160;&#160;
     		<a href="deleteTopic?tid=${t.tid }">删除</a>     	
     	</li>
     </c:forEach>
